        ...
        <div class="right-box">
            ...
            <form action="${pageContext.request.contextPath}/loginServlet" method="get">
                ...
                <div class="verification">
                    <input type="text" name="verification" data-place="#label4" id="input4" autocomplete="off">
                    <a href="javascript:refreshCode();"><img id="recode" class="img" src="${pageContext.request.contextPath}/checkCodeServlet" alt="看不清换一张" title="看不清换一张"></a>
                </div>
                <input type="submit" value="login" name="true" id="loginbtn">
                <input type="submit" value="sign" name="false" id="signbtn">
            </form>
        </div>
    </div>
</div>
